...
# Calculate susceptibility delta for week one
S_1 = s_dot(b_a, S_0, I_a, TFN_a, TISO_an, b_s, I_s, TFN_s, TISO_sn)
S_1 = S_0 + S_1

# Calculate infected and asymptomatic delta for week one
I_a_1 = I_a_dot(p0, b_a, S_0, I_a, TFN_a, TISO_an, b_s, I_s, TFN_s, TISO_sn, T_pcr, T_rap, gamma)
I_a_1 = I_a + I_a_1

# Calculate infected and symptomatic delta for week one
I_s_1 = I_s_dot(p0, b_a, S_0, I_a, TFN_a, TISO_an, b_s, I_s, TFN_s, TISO_sn, T_pcr, T_rap, gamma)
I_s_1 = I_s + I_s_1

# Calculate population tested with a false negative and asymptomatic for week one
TFN_a_1 = TFN_a_dot(T_pcr, FNpcr_a, I_a, T_rap, FNrap_a, gamma, TFN_a)
TFN_a_1 = TFN_a + TFN_a_1

# Calculate population tested with a false negative and symptomatic for week one
TFN_s_1 = TFN_s_dot(T_pcr, FNpcr_s, I_s, T_rap, FNrap_s, gamma, TFN_s)
TFN_s_1 = TFN_s + TFN_s_1

# Calculate population infected and tested, in isolation, and asymptomatic for week one
TISO_ap_1 = TISO_ap_dot(c_a, T_pcr, FNpcr_a, I_a, T_rap, FNrap_a, gamma, TISO_ap)
TISO_ap_1 = TISO_ap + TISO_ap_1
```
