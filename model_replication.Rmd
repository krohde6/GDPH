...
testing <- 0
pcr <- TRUE
school <- generate_school(toString(county), days, masking, student_pop, faculty_pop, student_vax, faculty_vax, testing, pcr)
...
FNpcr_a = 0.11    # false negative rate of a PCR test for asymptomatic patients
FNpcr_s = 0.11    # false negative rate of a PCR test for symptomatic patients
