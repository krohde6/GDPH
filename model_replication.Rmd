...
initial_susceptibility <- function(county_data) {
  # (population - total cases) / (county population)
}

initial_infected <- function(county_data) {
  # (past 14 day cases) / (county population)
}

recovered <- function(county_data) {
  # (total cases - past 14 day cases) / (county population)
}
```
...
I_s = initial_infected(county_data) / 2    # initial infected and symptomatic
I_a = initial_infected(county_data) / 2    # initial infected and asymptomatic
